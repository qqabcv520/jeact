...
export class CascaderComponent extends ValueComponent<any[]> {
  ...
  checkSearchOption() {
    this.searchCheckedAll =
      this.searchOptions?.length && this.searchOptions.every((value) => value.originOption.checked);
  }
                        ...
                        {this.searchOptions.map((value) => (
                          <label key={value.value} class="bgx-label bgx-search-option">
                            <input
                              class="bgx-checkbox"
                              type="checkbox"
                              checked={value.originOption.checked}
                              onchange={(e) => this.optionChange(e, value.originOption)}
                            />
            ...
            <div class="bgx-commonly-used-options">
              {this.showCommon &&
                ...
                this.commonOptions.map((value) => (
                  <label
                    key={value.value}
                    class="bgx-label bgx-commonly-used-option"
                    title={value.label}
                  >
                    <input
                      class="bgx-checkbox"
          ...
          <div class="bgx-selected-tags">
            {this.checkedOptions.map((value) => (
              <div class="bgx-selected-tag">
                {value.label}
                <span class="bgx-close" onclick={() => this.checkOption(value, false)}>
                  ×
                </span>
              </div>
            ))}
